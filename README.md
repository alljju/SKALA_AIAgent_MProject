...
---
## 🧠 Agents 
### 1. 시장 인사이트 통합 수집 에이전트

 **1-1. 국가별 시장 조사 에이전트**

- **목표**: 미국과 몽골의 시장 규모, 규제 요건
- **기능**: 해당 국가의 물류/유통 시장 규모, 주요 기업
    - **작업**:
...
- **목표**: If-Then 규칙 기반 **전략 적합성 평가·점수화·루프 제어**
- **기능**: 전략 실행의 타당성을 평가하고, 점수 기반으로 다음 단계를 결정
    - **작업**:
        - 전략 적합성 평가 (법규, 투자, 속도, 통제력, 리스크 등)
        - 부족 항목 판정 (법/시장/파트너/가정)
        - 재평가 루프 제어 (임계점 미달 시 이전 단계로 회귀)
        - 전략 권고안 생성
